...
<body bgcolor="#353B48">
	...
	<form action="" class="register">
	  <div class="gridRegister">
		  ...
		  <div class="Form-Title"> Your Info <hr style="border: 1px solid #D7C13F" width="100%"></div>
		  ...
		  <div><input name="regPhone" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
					  class="form-control mr-sm-2" type="number" placeholder="Phone Number" aria-label="Phone Number" maxlength="12"></div>
		  <div><input name="regConfPass" class="form-control mr-sm-2" type="password" placeholder="Confirm Password" aria-label="Confirm Password" maxlength="12"></div>
		  <div class="Gender">
			  <!--girl-->
