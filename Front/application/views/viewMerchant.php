    ...
    <div class="merchantInfo" style="z-index: 3;">
        <div class="merchantWrapper">
            ...
            <div class="rating">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="37.353" height="30" viewBox="0 0 10.5 21">
                    <path id="Icon_awesome-star-half" data-name="Icon awesome-star-half" d="M11.941,0a1.237,1.237,0,0,0-1.127.73L8.252,6.161l-5.735.87a1.33,1.33,0,0,0-.695,2.24L5.971,13.5,4.99,19.465a1.268,1.268,0,0,0,1.821,1.382l5.13-2.814Z" transform="translate(-1.441)" fill="#d7c13f" />
                </svg>
            </div>
        </div>
        <div class="buttons">
