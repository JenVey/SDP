...
<head>
	...
	<style type="text/css">
		...
		@import url("CSS/shopCSS.css");
		@import url("CSS/profileCSS.css");
		@import url("CSS/cartCSS.css");
		@import url("CSS/themes/default.min.css");
...
<body>
	...
	<div class="profilePage">
		<div class="merchantImg">
			...
			<div class="merchantImgWrapper"></div>
		</div>
		<h3 id="merchantName" style="color:#D7C13F; margin-top: 30px;">Your Merchant name</h3>
		<div class="description">
			<div id="descriptionArea">Your Bio</div>
		...
		<button class="addMerchant">Create My Merchant</button>
		...
		<div class="itemMerchantContainer">
			<div class="cartItemContainer">
				<div class="cartItemWrapper" id="item1">
					...
					<div class="action">
						<button class="saveChanges" id="1saveChanges" onClick="saveChanges(1)" hidden="true">
						...
						<button class="editItem" id="edit1Item" onClick="editItem(1)">
							<svg xmlns="http://www.w3.org/2000/svg" width="33" height="33" viewBox="0 0 35 35">
								<g id="Group_186" data-name="Group 186" transform="translate(-15955 3415)">
									<g id="Rectangle_346" data-name="Rectangle 346" transform="translate(15955 -3415)" fill="#d7c13f" stroke="#d7c13f" stroke-width="1">
										<rect width="35" height="35" rx="7" stroke="none" />
					...
					<div class="cartItem" id="item1Wrapper" hovered="true" onClick="viewItem(1)">
						<div class="itemImage">
							<div class="itemImgContainer" id="item1ImgContainer">
								<img id="item1DisplayIMG" src="Images/R6.jpg" alt="">
							</div>
							...
							<input type="file" name="item1IMG" id="item1IMG" accept="image/x-png,image/jpg,image/jpeg" style="display: none;" />
						</div>
						<div class="itemDescWrapper">
							<h5 class="itemName yellow" id="name1" style="display: inline-block;" contenteditable="true">Skin Default</h5>
							<div class="selectGame">
								<h6 style="margin-bottom: 10px;">Game</h6>
								<h4 id="item1Game" class="yellow">CSGO</h4>
						...
						<div class="desc">
							<p id="desc1">"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."</p>
						</div>
						<div class="amount">
							<h4 id="item1Amount" class="yellow" contenteditable="false">3</h4>
							<div class="minplusButton" id="amountBut1" hidden="true">
						...
						<div class="subtotal">
							<h4 id="item1Price" style="color:#63D99E;" onblur="savePrice(1)">IDR 9.000.000</h4>
						</div>
					</div>
				</div>
			</div>
	...
	<script>
		...
		function saveChanges(idDiv) {
			...
			if (isNaN(price)) {
				...
				var selected = $("#select" + idDiv + "Game").children("option:selected").val();
		...
		function viewItem(idDiv) {
			if ($("#" + idDiv + "saveChanges").attr("hidden") == "hidden") {
				alertify.alert('Morning Owl', 'pindah ke viewItem rob');
			}
		}
