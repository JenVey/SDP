            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">ListPromo</a></li>
                        <li class="breadcrumb-item active">InsertPromo</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-md-6">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Insert Promo</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form method="post" action="<?= base_url(); ?>Promo/insert">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="kodepromo" placeholder="Enter Your Kode Promo">
                            </div>
                            <div class=" form-group">
                                <label>Potongan (%)</label>
                                <input type="text" class="form-control col-1" name="potongan" placeholder="1-100">
                            </div>
                            <div class=" form-group">
                                <label>Maksimal (IDR)</label>
                                <input type="text" class="form-control col-3" name="maksimal" placeholder="Nominal">
                            </div>
                            <div class="form-group">
